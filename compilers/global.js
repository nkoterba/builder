...
exports.sfx = function(loader) {
  // NB can conditionally exclude this if all globals in the tree have `metadata.exports` specified
  return require('fs').readFileSync('../templates/global-helpers.js').toString();
}
